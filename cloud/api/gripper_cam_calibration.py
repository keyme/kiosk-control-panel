# Gripper camera calibration: flat list under gripper_cam_calibration/{kiosk_short_name}/.
...
def list_gripper_cam_runs(s3_client, bucket: str, kiosk: str) -> list[dict]:
