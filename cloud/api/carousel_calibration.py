# Carousel calibration: flat list under carousel_calibration/{kiosk_short_name}/.
...
def list_carousel_runs(s3_client, bucket: str, kiosk: str) -> list[dict]:
