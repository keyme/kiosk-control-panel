...
def _dispatch_request(client_id, request_id, event, data, connection_count, connection_list):
    ...
    event_handlers = {
        ...
        'inventory_restore_from_payload': lambda: handlers.inventory_restore_from_payload(
            data or {},
            send_progress=lambda p: _schedule_send(client_id, {'event': ws_protocol.PUSH_INVENTORY_RESTORE_PROGRESS, 'data': p}),
        ),
    }
